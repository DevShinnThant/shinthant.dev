...
export default function HeroContent() {
  return (
    <div className="relative max-w-[55rem] mt-[11rem] m-auto w-full flex flex-col gap-4 justify-center items-center">
      <div className="bg-[linear-gradient(#fff,rgba(255,255,255,.6))] inline-block text-transparent bg-clip-text  leading-none text-4xl md:text-6xl font-semibold">
        It&apos;s Shinn Thant
      </div>
      ...
      <div className=" w-[300px] text-center md:w-[370px] text-sm bg-[linear-gradient(#fff,rgba(255,255,255,.6))] inline-block text-transparent bg-clip-text">
      ...
      <div className="bg-[linear-gradient(#fff,rgba(255,255,255,.6))] inline-block text-transparent bg-clip-text text-md md:text-lg">
